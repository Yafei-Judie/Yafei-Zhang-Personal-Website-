...
<div class="proj-intro">
  <p>Six projects, ordered by the business decision each one actually changes — not by how fancy the model is. Every chart and diagram below is a real output from my own analysis, not a mockup.</p>
</div>
