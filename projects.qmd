...
<div class="proj-intro">
  <p>Five projects, ordered by the business decision each one actually changes — not by how fancy the model is. Every chart below is a real output from my own analysis, not a mockup.</p>
</div>
