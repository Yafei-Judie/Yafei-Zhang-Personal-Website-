...
description: "Compared a standard propensity model against uplift models across Neural Network, Random Forest, and XGBoost to find the targeting rule that maximizes incremental profit — not just response rate."
date: 2025-02-10
...
The gap between the two curves *is* the money a propensity-only targeting strategy leaves on the table — or overspends chasing customers who were never incremental in the first place. For a marketing or growth analytics role, this is the difference between "who looks like a buyer" and "who our spend actually moves" — the second question is the one that protects budget.
