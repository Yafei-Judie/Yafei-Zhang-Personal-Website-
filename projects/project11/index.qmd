...
![Counties with the highest overdose rates cluster at low clinic counts, a pattern consistent with clinics being deployed in response to an existing crisis rather than preventing one](../../images/projects/opioid/clinic-count-vs-od-rate.png){fig-alt="Scatterplot of SAMHSA clinic count per county against overdose rate per 100,000 residents, showing the highest overdose rates concentrated among counties with very few clinics"}
